            ...
            <div class="col-sm-12 col-md-10 col-lg-12">
                <form class="form-horizontal" action="<?php echo Configure::read('App.Domain') ?>merchants/save"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="id_cart" class="form-control input-md" id="id_cart"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="shop_name" class="form-control input-md" id="shop_name"
                    ...
                    <div class="form-group">
                        <label for="address" class="col-sm-2 control-label">ที่อยู่ <span
                                    class="text-danger">*</span></label>
                        <div class="col-sm-4">
                            <input required type="text" name="address" class="form-control input-md" id="address"
                                   placeholder="Address">
                        </div>
                    ...
                    <div class="form-group">
                        <label for="zipcode" class="col-sm-2 control-label">รหัสไปรษณีย์ <span
                                    class="text-danger">*</span></label>
                        <div class="col-sm-4">
                            <input required type="text" name="zipcode" class="form-control input-md" id="zipcode"
                                   placeholder="xxxxx">
                        </div>
                        <label for="document" class="col-sm-2 control-label">ไฟล์เอกสารแนบ <span
                                    class="text-danger">*</span></label>
                        <div class="col-sm-4">
